...
public class CreditPage {
    ...
    private SelenideElement creditTitle = $(byText("Кредит по данным карты"));
    ...
    public void payWithCreditCard(String number, String month, String year, String name, String CVC) {
