...
1.  Покупка тура с валидными данными карты (номер из 16 цифр, месяц число от 1 до 12, год число между 23 и 30, имя из двух слов латиницей, CVC любое трехзначное число) и ожидаемым результатом карты одобрено  
...
2. Покупка тура с валидными данными карты (номер из 16 цифр, месяц число от 1 до 12, год число между 23 и 30, имя из двух слов латиницей, CVC любое трехзначное число) и ожидаемым результатом карты отказано
...
8. Покупка тура с невалидными данными в поле “месяц” (0)

Открыть страницу с покупкой тура - нажать кнопку “купить” - ввести невалидные данные в поле “месяц” - 0, в остальные поля - валидные: номер карты 4444 4444 4444 4441, год 25, владелец John Smith, CVC 123) - нажать кнопку “продолжить” - дождаться сообщения “неверный формат”
...
13. Покупка тура с невалидными данными в поле “год” (число меньше 23)
...
30. Покупка тура в кредит с валидными данными карты (номер из 16 цифр, месяц число от 1 до 12, год число между 23 и 30, имя из двух слов латиницей, CVC любое трехзначное число) и ожидаемым результатом карты одобрено  
...
31. Покупка тура в кредит с валидными данными карты (номер из 16 цифр, месяц число от 1 до 12, год число между 23 и 30, имя из двух слов латиницей, CVC любое трехзначное число) и ожидаемым результатом карты отказано
...
37. Покупка тура в кредит с невалидными данными в поле “месяц” (0)
...
42. Покупка тура в кредит с невалидными данными в поле “год” (число меньше 23)
